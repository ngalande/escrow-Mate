...
const navigation = [
  ...
  { name: "Wallet", href: "/wallet", icon: UsersIcon, current: false },
  {
    name: "Transactions",
    href: "/transactions",
    icon: FolderIcon,
  ...
  { name: "Delivery", href: "/delivery", icon: CalendarIcon, current: false },
  {
    name: "Dispute",
    href: "/dispute",
...
const activeNavItemAtom = atom("/dashboard");
                  ...
                  <ul className="-mx-2 space-y-1">
                    {navigation.map((item, i) => (
                      <li key={i}>
                        ...
                        >
                          <item.icon
                            className={`h-6 w-6 shrink-0 ${activeNavItem === item.href
                                ? "text-blue-600"
                                : "text-gray-400 group-hover:text-blue-600"
                              }
                              `}
